...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number=PhoneNumberField(verbose_name=_("Phone Number"),max_length=30,default="+4152420242"),
    about_me=models.TextField(verbose_name=_("About_me"),default="Say something about yourself")
    licence = models.CharField(verbose_name=_("Real Estaet licence"),max_length=20,blank=True,null=True)
